...
import { main, container, text, mySkills, skillsIcons, myEducation, educationIcons} from './AboutLight.module.scss';
    ...
    return (
        <div className={main}>
            ...
            <div className={container}>
                <div className={text} >
                    <TextLight text={mainText} fontsize='3vh' />
                </div>
                <div className={mySkills}>
                    <HeaderLight text='Skills' fontsize='50px' />
                ...
                <div className={myEducation}>
                    <HeaderLight text='Education' fontsize='50px' />
